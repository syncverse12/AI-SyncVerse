...
SKILL_KEYWORDS: List[str] = [
    ...
    "tensorflow", "langchain", "langchain", "opencv", "mlflow", "scikit-learn",
    ...
    def _detect_skills(self, text: str) -> List[str]:
        ...
        for s in found:
            ...
            if key not in seen:
                seen.add(key)
                unique.append(s)
        return unique or ["Python"]   # fallback
