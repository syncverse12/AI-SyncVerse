...
Stateless — no DB, no Redis, no WebSocket dependencies.
"""
import json
import re
import logging
...
async def chat_complete(
    ...
    """Send a completion request to Groq. Returns raw response string."""
...
def safe_parse_json(raw: str) -> Optional[dict]:
    """Parse JSON, with fallback regex extraction for malformed responses."""
    if not raw:
        return None
    try:
